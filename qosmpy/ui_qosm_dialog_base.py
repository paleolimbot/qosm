...
# Form implementation generated from reading ui file 'qosm_dialog_base.ui'
#
...
class Ui_qosmDialogBase(object):
    def setupUi(self, qosmDialogBase):
        ...
        self.comboBox = QtGui.QComboBox(qosmDialogBase)
        self.comboBox.setObjectName(_fromUtf8("comboBox"))
        self.horizontalLayout.addWidget(self.comboBox)
        self.verticalLayout.addLayout(self.horizontalLayout)
        self.horizontalLayout_2 = QtGui.QHBoxLayout()
        self.horizontalLayout_2.setObjectName(_fromUtf8("horizontalLayout_2"))
        self.lineEdit = QtGui.QLineEdit(qosmDialogBase)
        self.lineEdit.setObjectName(_fromUtf8("lineEdit"))
        self.horizontalLayout_2.addWidget(self.lineEdit)
        self.pushButton = QtGui.QPushButton(qosmDialogBase)
        self.pushButton.setObjectName(_fromUtf8("pushButton"))
        self.horizontalLayout_2.addWidget(self.pushButton)
        self.verticalLayout.addLayout(self.horizontalLayout_2)
        self.horizontalLayout_3 = QtGui.QHBoxLayout()
        self.horizontalLayout_3.setObjectName(_fromUtf8("horizontalLayout_3"))
        self.checkBox = QtGui.QCheckBox(qosmDialogBase)
    ...
    def retranslateUi(self, qosmDialogBase):
        qosmDialogBase.setWindowTitle(_translate("qosmDialogBase", "qosm", None))
        self.label.setText(_translate("qosmDialogBase", "Select map type", None))
        self.lineEdit.setPlaceholderText(_translate("qosmDialogBase", "http://a.tile.opencyclemap.org/cycle/${z}/${x}/${y}.png", None))
        self.pushButton.setText(_translate("qosmDialogBase", "Add Custom Type", None))
        self.checkBox.setText(_translate("qosmDialogBase", "Auto refresh map when extent changes", None))
